...
function MainPage() {
  return (
    ...
    <div class="container d-flex justify-content-between align-items-center">
      ...
      <div class="logo">
        <h1><a href="index.html">TPQ DUAFA</a></h1>
        ...
        <div class="col-12 hero-text-image">
          <div class="row">
            <div class="col-lg-8 text-center text-lg-start">
              <h1 data-aos="fade-right">Lembaga Taman Pendidikan Al-Quran</h1>
              <p class="mb-5" data-aos="fade-right" data-aos-delay="100">Lorem ipsum dolor sit amet, consectetur
                adipisicing elit.</p>
              <Link to="/login">
                <p data-aos="fade-right" data-aos-delay="200" data-aos-offset="-500"><a class="btn btn-outline-white">Login</a></p>
              </Link>
            </div>
            <div class="col-lg-4 iphone-wrap">
              <img src="assets/img/tpq.jpeg" alt="Image" class="phone-1" data-aos="fade-right"/>
              <img src="assets/img/TPQ.png" alt="Image" class="phone-2" data-aos="fade-right" data-aos-delay="200"/>
            </div>
          </div>
        </div>
      </div>
